...
export class ImportEntry {
    constructor(ordinal, hint, name, iatRva, iatFileOffset, iatValue) {
...
export class ImportDescriptor {
    constructor(dllName, entries, originalFirstThunk, firstThunk) {
...
export class ImportTable {
    ...
    parseThunks(fileImage, sections, thunkRva, firstThunkRva, isPE32Plus) {
        const entries = [];
